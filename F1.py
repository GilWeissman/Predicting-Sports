...
adress_train_F1 = 'trainingSetF1.csv'
adress_test_F12018 = 'testSetF12018.csv'
adress_current_test_F1 = 'currentTestSetF1.csv'
...
trainingSet = pd.read_csv(adress_train_F1, header=0)
testSet = pd.read_csv(adress_test_F12018, header=0)
...
for i in range(len(X_test)):
    ...
    if 0.5 < dRatios1[0] and bet365[0] < 5:
        count += 1
        if y_test[i] != 'H':
            print("no", bet365)
            value -= 1
...
if 0.5 < dRatios1[0] and new_bet365[0] < 5:
    print("bet H")
if 1.34 < dRatios2[1] and new_bet365[1] < 3.8:
    print("Bet D")
if 0.8 < dRatios3[2] < 0.9 and new_bet365[2] > 4:
    print("Bet A")
